...
This project represents a simple calculator for easy calculation.
...
1. enter any number you want by clicking on the numbers
2. add a operator by clicking on an operator on the right side
3. enter a second number to the calculation
4. finally click on the button with the equal sign
5. now you can see your calculations' result
